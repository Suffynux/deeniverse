  ...
  return (
    <FullWidth>
      <section className="relative w-full overflow-hidden">
        ...
        <Container className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-10 min-h-[90vh] py-16">
          {/* Text Section (Already responsive) */}
          <motion.div
            initial={{ opacity: 0, x: -50 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
          ...
          >
            <div>
              <h1
                className="mx-auto text-center md:text-left max-w-2xl font-extrabold tracking-tight leading-tight
                 text-4xl sm:text-5xl md:text-5xl lg:text-5xl" // Made text larger for Hero section impact
              >
                <span className="inline-block bg-clip-text text-transparent bg-gradient-to-r from-[#C0A34E] to-white">
                  Discover Divine Wisdom
                </span>
            ...
            {/* Hadith Icons Section Below Text (Already responsive) */}
          ...
          {/* Image Section with Icons Below (Already responsive) */}
          <motion.div
            initial={{ opacity: 0, x: 50, scale: 0.95 }}
            animate={{ opacity: 1, x: 0, scale: 1 }}
            transition={{ duration: 0.8 }}
          ...
          >
            ...
            {/* Icons below image (Already responsive) */}
            <div className="mt-6 grid grid-cols-3 gap-4 text-center">
              <div className="flex flex-col items-center">
                <BookOpenCheck className="w-8 h-8 text-[#C0A34E]" />
                <span className="text-sm text-gray-200 mt-2">Guidance</span>
...
// ----------------------------------------------------------------------
// ConnectSection has been refactored for responsiveness
// ----------------------------------------------------------------------

const ConnectSection = () => {
  return (
    <section
      className="bg-[#ECEFCA] py-16 px-4 min-h-screen" // Replaced inline styles with Tailwind classes
    >
      <Container>
        {/* Headline */}
        <h1
          className="text-center text-[#182f51] font-extrabold mb-8 
             text-3xl sm:text-4xl lg:text-5xl xl:text-6xl leading-tight" // Responsive font sizes
        >
          Connect Directly to the Words of <br className="hidden md:block" />{" "}
          Allah Beyond Translation
        </h1>

        {/* Cards Row (using responsive flex/grid) */}
        <div className="flex flex-col lg:flex-row gap-8 justify-center items-stretch mt-12">
          {/* Card 1 */}
          <div className="flex-1 max-w-xl w-full mx-auto lg:mx-0">
            <WarpBackground>
              <div
                className="flex flex-col items-center justify-center w-full h-full p-8 rounded-2xl shadow-xl 
                           bg-white text-[#182f51]" // Added text color class
              >
                <h2 className="text-center font-bold mb-4 text-2xl sm:text-3xl lg:text-4xl leading-snug">
                  Learn the Quran <br /> at <span className="font-bolder">Your Own Pace</span>
                </h2>

                <p className="text-center text-base font-semibold mb-7 max-w-sm">
                  Whether you're a passive listener or an active note-taker, our
                  selection of courses lays the groundwork for a personalized
                  Quran journey.
                </p>
                <Link to={"/courses"}>
                  <ShinyButton className="text-white bg-[#182f51]">
          ...
          <div className="flex-1 max-w-xl w-full mx-auto lg:mx-0">
            <WarpBackground>
              ...
              >
                ...
                <p className="text-center text-base font-semibold mb-7 max-w-sm">
                  Complete structured Quizzes and receive certification upon
                  success.
                </p>
